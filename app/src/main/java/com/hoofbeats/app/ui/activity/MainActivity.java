...
import com.hoofbeats.app.util.BuildExtension;
import com.hoofbeats.app.util.Config;
import com.hoofbeats.app.util.FrameSaver;
import com.hoofbeats.app.util.SystemUiHider;
...
public class MainActivity extends Activity implements Device.Delegate, FrameProcessor.Delegate, Device.StreamDelegate, Device.PowerUpdateDelegate {
    ...
    private File outputDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
        ...
        mSystemUiHider
                .setOnVisibilityChangeListener(new SystemUiHider.OnVisibilityChangeListener() {
                    ...
                    public void onVisibilityChange(boolean visible) {
                        ...
                        if (visible && !((ToggleButton) findViewById(R.id.change_view_button)).isChecked() && mSystemUiHider.AUTO_HIDE) {
                            // Schedule a hide().
    ...
    public void onDeviceConnected(Device device) {
        Log.i("Hoofbeats", "Device connected!");
    ...
    public void onDeviceDisconnected(Device device) {
        Log.i("Hoofbeats", "Device disconnected!");
    ...
    public void onTuningStateChanged(Device.TuningState tuningState) {
        Log.i("Hoofbeats", "Tuning state changed changed!");
    ...
    public void onBatteryChargingStateReceived(final Device.BatteryChargingState batteryChargingState) {
        Log.i("Hoofbeats", "Battery charging state received!");
    ...
    public void onBatteryPercentageReceived(final byte percentage) {
        Log.i("Hoofbeats", "Battery percentage received!");
    ...
    public void onFrameReceived(Frame frame) {
        Log.v("Hoofbeats", "Frame received!");
    ...
    private void CaptureImage(final RenderedImage renderedImage) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                lastSavedPath = FrameSaver.saveFrame(MainActivity.this, renderedImage.getFrame());
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        findViewById(R.id.saving).setVisibility(View.INVISIBLE);
